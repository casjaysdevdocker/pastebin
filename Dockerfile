...
ARG BUILD_DATE="Thu Aug 24 12:54:32 AM EDT 2023"
ARG LANGUAGE="en_US.UTF-8"
ARG TIMEZONE="America/New_York"
ARG WWW_ROOT_DIR="/usr/share/webapps/pastebin"
...
ENV HOSTNAME="casjaysdev-pastebin"
...
RUN set -ex; \
  rm -Rf "${WWW_ROOT_DIR}"; \
  git clone -q https://github.com/claudehohl/Stikked /tmp/stikked; \
  mv -f "/tmp/stikked/htdocs" "${WWW_ROOT_DIR}/"; \
  ln -sf "{WWW_ROOT_DIR}/application/config/stikked.php" "/etc/pastebin/config.php"; \
  echo ""
...
LABEL org.opencontainers.image.vcs-url="https://hub.docker.com/r/casjaysdevdocker/pastebin"
LABEL org.opencontainers.image.documentation="https://hub.docker.com/r/casjaysdevdocker/pastebin"
